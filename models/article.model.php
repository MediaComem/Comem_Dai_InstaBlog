...
class Article {
  ...
  /**
   * Valide que les données contenues dans $inputs respectent les contraintes relatives à un article.
   ...
   * @param {Array} $inputs - Un tableau contenant toutes les valeurs du nouvel article à créer
   */
