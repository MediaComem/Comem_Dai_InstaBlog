...
class Suivi {
  ...
  /**
   * Valide que les données contenues dans $inputs respectent les contraintes relatives à un suivi.
   ...
   * @param {Array} $inputs - Un tableau contenant toutes les valeurs du nouveau suivi à créer
   */
