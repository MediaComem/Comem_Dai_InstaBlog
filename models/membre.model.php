...
class Membre {
  ...
  /**
   * Valide que les données contenues dans $inputs respectent les contraintes relatives à un membre.
   ...
   * @param {Array} $inputs - Un tableau contenant toutes les valeurs du nouveau membre à créer
   */
